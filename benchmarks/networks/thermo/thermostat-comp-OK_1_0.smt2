...
(assert (<= 1 mode_1))
(assert (<= mode_1 4))
(assert (and (= mode_1 4) (and (= pr_0_0 1) (or (= on_0_0 1) (= on_0_0 0)) (< o2_0_0 (+ 21 3)) (< (- 19 3) o2_0_0) (< o1_0_0 (+ 21 3)) (< (- 19 3) o1_0_0) (< vx_0_0 (+ 21 2)) (< (- 19 2) vx_0_0) (< x_0_0 (+ 21 2)) (< (- 19 2) x_0_0) (<= tr_0_0 0.014) (<= 0.01 tr_0_0)) (= mode_0 1) (or (and (= mode_1 4) (or (>= x_0_t (+ 21 3)) (>= (- 19 3) x_0_t)) (= pr_1_0 pr_0_t) (= tr_1_0 tr_0_t) (= on_1_0 on_0_t) (= o2_1_0 o2_0_t) (= o1_1_0 o1_0_t) (= vx_1_0 vx_0_t) (= x_1_0 x_0_t)) (and (= mode_1 2) (= tr_0_t 0) (= pr_1_0 pr_0_t) (= tr_1_0 0.2) (= on_1_0 on_0_t) (= o2_1_0 o2_0_t) (= o1_1_0 o1_0_t) (= vx_1_0 x_0_t) (= x_1_0 x_0_t))) (= [o1_0_t o2_0_t on_0_t pr_0_t tr_0_t vx_0_t x_0_t] (integral 0. time_0 [o1_0_0 o2_0_0 on_0_0 pr_0_0 tr_0_0 vx_0_0 x_0_0] flow_1)) (= mode_0 1) (forall_t 1 [0 time_0] (and (<= x_0_t (+ 21 3)) (<= (- 19 3) x_0_t))) (<= x_0_0 (+ 21 3)) (<= (- 19 3) x_0_0) (<= x_0_t (+ 21 3)) (<= (- 19 3) x_0_t) (= [o1_1_t o2_1_t on_1_t pr_1_t tr_1_t vx_1_t x_1_t] (integral 0. time_1 [o1_1_0 o2_1_0 on_1_0 pr_1_0 tr_1_0 vx_1_0 x_1_0] flow_4)) (= mode_1 4)))
(check-sat)
(exit)
