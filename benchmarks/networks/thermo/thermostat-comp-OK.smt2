...
(assert (<= 1 mode_2))
(assert (<= mode_2 3))
(assert (and (and (= pr_0_0 1) (or (= on_0_0 1) (= on_0_0 0)) (< o2_0_0 (+ 21 3)) (< (- 19 3) o2_0_0) (< o1_0_0 (+ 21 3)) (< (- 19 3) o1_0_0) (< vx_0_0 (+ 21 2)) (< (- 19 2) vx_0_0) (< x_0_0 (+ 21 2)) (< (- 19 2) x_0_0) (<= tr_0_0 0.014) (<= 0.01 tr_0_0)) (= mode_0 1) (= [o1_0_t o2_0_t on_0_t pr_0_t tr_0_t vx_0_t x_0_t] (integral 0. time_0 [o1_0_0 o2_0_0 on_0_0 pr_0_0 tr_0_0 vx_0_0 x_0_0] flow_1)) (= mode_0 1) (= mode_1 2) (= tr_0_t 0) (= pr_1_0 pr_0_t) (= tr_1_0 0.2) (= on_1_0 on_0_t) (= o2_1_0 o2_0_t) (= o1_1_0 o1_0_t) (= vx_1_0 x_0_t) (= x_1_0 x_0_t) (= [o1_1_t o2_1_t on_1_t pr_1_t tr_1_t vx_1_t x_1_t] (integral 0. time_1 [o1_1_0 o2_1_0 on_1_0 pr_1_0 tr_1_0 vx_1_0 x_1_0] flow_2)) (= mode_1 2) (= mode_2 3) (= tr_1_t 0) (= pr_2_0 pr_1_t) (= tr_2_0 pr_1_t) (or (and (= on_2_0 0) (>= vx_1_t 19) (= on_1_t 0)) (and (= on_2_0 1) (< vx_1_t 19) (= on_1_t 0)) (and (= on_2_0 0) (> vx_1_t 21) (= on_1_t 1)) (and (= on_2_0 1) (<= vx_1_t 21) (= on_1_t 1))) (= o2_2_0 o2_1_t) (= o1_2_0 o1_1_t) (= vx_2_0 vx_1_t) (= x_2_0 x_1_t) (= [o1_2_t o2_2_t on_2_t pr_2_t tr_2_t vx_2_t x_2_t] (integral 0. time_2 [o1_2_0 o2_2_0 on_2_0 pr_2_0 tr_2_0 vx_2_0 x_2_0] flow_3)) (= mode_2 3) (= mode_2 3) (or (>= x_2_t (+ 21 2)) (>= (- 19 2) x_2_t)) (= pr_2_t 0)))
(check-sat)
(exit)
