...
(declare-fun in_3_0 () Real [8.0])
(declare-fun in_3_t () Real [8.0])
...
(define-ode flow_4 ((= d/dt[in] 0) (= d/dt[on] 0) (= d/dt[pr] -1) (= d/dt[tr] -1) (= d/dt[vx] 0) (= d/dt[x] (+ (* on (/ (+ 4 (* (^ (* 2 9.80665) 0.5) (- (* 0.5 (^ in 0.5)) (* 0.6 (^ x 0.5))))) 2)) (* (- 1 on) (/ (* (^ (* 2 9.80665) 0.5) (- (* 0.5 (^ in 0.5)) (* 0.6 (^ x 0.5)))) 2))))))
(assert (<= 0 x_0_0))
(assert (<= x_0_0 50))
(assert (<= 0 x_0_t))
(assert (<= x_0_t 50))
...
(assert (<= 1 mode_3))
(assert (<= mode_3 4))
(assert (and (= mode_3 4) (and (= pr_0_0 1) (or (= on_0_0 1) (= on_0_0 0)) (< in_0_0 (+ 10 3)) (< (- 8 3) in_0_0) (< vx_0_0 (+ 10 2)) (< (- 8 2) vx_0_0) (< x_0_0 (+ 10 2)) (< (- 8 2) x_0_0) (<= tr_0_0 0.08) (<= 0.02 tr_0_0)) (= mode_0 1) (or (and (= mode_1 4) (or (>= x_0_t (+ 10 3)) (>= (- 8 3) x_0_t)) (= pr_1_0 pr_0_t) (= tr_1_0 tr_0_t) (= on_1_0 on_0_t) (= in_1_0 in_0_t) (= vx_1_0 vx_0_t) (= x_1_0 x_0_t)) (and (= mode_1 2) (= tr_0_t 0) (= pr_1_0 pr_0_t) (= tr_1_0 0.1) (= on_1_0 on_0_t) (= in_1_0 in_0_t) (= vx_1_0 x_0_t) (= x_1_0 x_0_t))) (= [in_0_t on_0_t pr_0_t tr_0_t vx_0_t x_0_t] (integral 0. time_0 [in_0_0 on_0_0 pr_0_0 tr_0_0 vx_0_0 x_0_0] flow_1)) (= mode_0 1) (forall_t 1 [0 time_0] (and (<= x_0_t (+ 10 3)) (<= (- 8 3) x_0_t))) (<= x_0_0 (+ 10 3)) (<= (- 8 3) x_0_0) (<= x_0_t (+ 10 3)) (<= (- 8 3) x_0_t) (or (and (= mode_2 4) (or (>= x_1_t (+ 10 3)) (>= (- 8 3) x_1_t)) (= pr_2_0 pr_1_t) (= tr_2_0 tr_1_t) (= on_2_0 on_1_t) (= in_2_0 in_1_t) (= vx_2_0 vx_1_t) (= x_2_0 x_1_t)) (and (= mode_2 3) (= tr_1_t 0) (= pr_2_0 pr_1_t) (= tr_2_0 pr_1_t) (or (and (= on_2_0 0) (>= vx_1_t 8) (= on_1_t 0)) (and (= on_2_0 1) (< vx_1_t 8) (= on_1_t 0)) (and (= on_2_0 0) (> vx_1_t 10) (= on_1_t 1)) (and (= on_2_0 1) (<= vx_1_t 10) (= on_1_t 1))) (= in_2_0 in_1_t) (= vx_2_0 vx_1_t) (= x_2_0 x_1_t))) (= [in_1_t on_1_t pr_1_t tr_1_t vx_1_t x_1_t] (integral 0. time_1 [in_1_0 on_1_0 pr_1_0 tr_1_0 vx_1_0 x_1_0] flow_2)) (= mode_1 2) (forall_t 2 [0 time_1] (and (<= x_1_t (+ 10 3)) (<= (- 8 3) x_1_t))) (<= x_1_0 (+ 10 3)) (<= (- 8 3) x_1_0) (<= x_1_t (+ 10 3)) (<= (- 8 3) x_1_t) (or (and (= mode_3 4) (or (>= x_2_t (+ 10 3)) (>= (- 8 3) x_2_t)) (= pr_3_0 pr_2_t) (= tr_3_0 tr_2_t) (= on_3_0 on_2_t) (= in_3_0 in_2_t) (= vx_3_0 vx_2_t) (= x_3_0 x_2_t)) (and (= mode_3 1) (= tr_2_t 0) (= pr_3_0 1) (= on_3_0 on_2_t) (= in_3_0 in_2_t) (= vx_3_0 vx_2_t) (= x_3_0 x_2_t) (<= tr_3_0 0.08) (<= 0.02 tr_3_0))) (= [in_2_t on_2_t pr_2_t tr_2_t vx_2_t x_2_t] (integral 0. time_2 [in_2_0 on_2_0 pr_2_0 tr_2_0 vx_2_0 x_2_0] flow_3)) (= mode_2 3) (forall_t 3 [0 time_2] (and (<= x_2_t (+ 10 3)) (<= (- 8 3) x_2_t))) (<= x_2_0 (+ 10 3)) (<= (- 8 3) x_2_0) (<= x_2_t (+ 10 3)) (<= (- 8 3) x_2_t) (= [in_3_t on_3_t pr_3_t tr_3_t vx_3_t x_3_t] (integral 0. time_3 [in_3_0 on_3_0 pr_3_0 tr_3_0 vx_3_0 x_3_0] flow_4)) (= mode_3 4)))
(check-sat)
(exit)
